package com.wildcodeschool.challenge.springHibernateChallenge.utils;

import com.wildcodeschool.challenge.springHibernateChallenge.entities.User;
import com.wildcodeschool.challenge.springHibernateChallenge.repositories.UserDao;
...
public class Outputter implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        User user3 = new User("Jason", "Wilder", 24);
        LOG.info("******************");
        ...
        tempUser.setFirstName("Jasonnette");
        tempUser.setLastName("Hu");
        tempUser.setAge(32);
